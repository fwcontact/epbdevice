...
//        java.text.SimpleDateFormat format = new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	...
	private static String getTaken(String appKey, String appSecret, String accessToken, String format, String method,
			String timestamp) {
		String s = appSecret
	...
	private static String getFullUrl(String url, String sign, String timestamp, String apiVersion,
		...
		return url + "?"
				...
				+ "&access_token="
				+ (accessToken == null || accessToken.length() == 0 ? "" : URLEncoder.encode(accessToken))
